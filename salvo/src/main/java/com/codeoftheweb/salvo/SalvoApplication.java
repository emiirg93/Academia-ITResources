...
public class SalvoApplication {
	...
	public CommandLineRunner initData(PlayerRepository playerRepository, GameRepository gameRepository, GamePlayerRepository gamePlayerRepository, ShipRepository shipRepository, SalvoRepository salvoRepository) {
		return (args) -> {
			...
			Ship s6 =shipRepository.save(new Ship("Destroyer",gp3,Ship.ApplicationLocations("B5","C5","D5")));
			Ship s7 =shipRepository.save(new Ship("Patrol Boat",gp3,Ship.ApplicationLocations("C6","C7")));

			Ship s8 =shipRepository.save(new Ship("Submarine",gp4,Ship.ApplicationLocations("A2","A3","A4")));
			Ship s9 =shipRepository.save(new Ship("Patrol Boat",gp4,Ship.ApplicationLocations("G6","H6")));

			Ship s10 =shipRepository.save(new Ship("Destroyer",gp5,Ship.ApplicationLocations("B5","C5","D5")));
			Ship s11 =shipRepository.save(new Ship("Patrol Boat",gp5,Ship.ApplicationLocations("C6","C7")));

			Ship s12 =shipRepository.save(new Ship("Submarine",gp6,Ship.ApplicationLocations("A2","A3","A4")));
			Ship s13 =shipRepository.save(new Ship("Patrol Boat",gp6,Ship.ApplicationLocations("G6","H6")));

			Ship s14 =shipRepository.save(new Ship("Destroyer",gp7,Ship.ApplicationLocations("B5","C5","D5")));
			Ship s15 =shipRepository.save(new Ship("Patrol Boat",gp7,Ship.ApplicationLocations("C6","C7")));

			Ship s16 =shipRepository.save(new Ship("Submarine",gp8,Ship.ApplicationLocations("A2","A3","A4")));
			Ship s17 =shipRepository.save(new Ship("Patrol Boat",gp8,Ship.ApplicationLocations("G6","H6")));

			Ship s18 =shipRepository.save(new Ship("Destroyer",gp9,Ship.ApplicationLocations("B5","C5","D5")));
			Ship s19 =shipRepository.save(new Ship("Patrol Boat",gp9,Ship.ApplicationLocations("C6","C7")));

			Ship s20 =shipRepository.save(new Ship("Submarine",gp8,Ship.ApplicationLocations("A2","A3","A4")));
			Ship s21 =shipRepository.save(new Ship("Patrol Boat",gp8,Ship.ApplicationLocations("G6","H6")));

			salvoRepository.save(new Salvo(s1.getGamePlayer(),1,Salvo.ApplicationLocations("B5","C5","F1")));
			salvoRepository.save(new Salvo(s2.getGamePlayer(),1,Salvo.ApplicationLocations("B4","B5","B6")));
